...
(function(global, factory) {
  ...
  /*
    ...
    */
  var CustomEvent$1 =
    typeof window !== "undefined" ? window.CustomEvent : undefined;
  ...
  function Timer() {
    ...
    function updateCounters(precision, roundedValue) {
      ...
      if (precision === DAYS) {
        ...
        counters[precision] =
          groupedUnits[precision] - mod(roundedValue, groupedUnits[precision]);
      }
    }
    ...
    function resetCounters() {
      for (var counter in counters) {
        if (
          counters.hasOwnProperty(counter) &&
          typeof counters[counter] === "number"
        ) {
          counters[counter] = 0;
        }
      }
      ...
      for (var _counter in totalCounters) {
        if (
          totalCounters.hasOwnProperty(_counter) &&
          typeof totalCounters[_counter] === "number"
        ) {
    ...
    function setParams(params) {
      params = params || {};
      precision =
        typeof params.precision === "string" ? params.precision : SECONDS;
      customCallback =
