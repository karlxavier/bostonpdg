...
var floatSubMenuTimeout,
    ...
    $(".sidebar .nav > .has-sub > a").click(function() {
      ...
      0 === $(".page-sidebar-minified").length &&
        ...
        $(a).slideToggle(t, function() {
          ...
          $(a).is(":visible")
            ? ($(e).addClass("expand"), $(e).removeClass("closed"))
            : ($(e).addClass("closed"), $(e).removeClass("expand")),
            $(e).removeClass("expanding closing");
        }));
    }),
  ...
  handleMobileSidebarToggle = function() {
    ...
    $(".sidebar").bind("click touchstart", function(e) {
      0 !== $(e.target).closest(".sidebar").length
        ? (n = !0)
    ...
    3 <= e && e < 4 ? (a = "in") : 4 <= e && e < 5 && (a = "show"),
      $(document).scroll(function() {
        200 <= $(document).scrollTop()
          ? $("[data-click=scroll-top]").addClass(a)
          : $("[data-click=scroll-top]").removeClass(a);
      }),
  ...
  handleThemePageStructureControl = function() {
    if (
      ...
      Cookies &&
        Cookies.get("theme") &&
        0 !== $(".theme-list [data-theme]").length &&
        $('.theme-list [data-theme="' + Cookies.get("theme") + '"]').trigger(
          "click"
        ),
      $(document).on(
        "change",
        ".theme-panel [name=header-styling]",
        function() {
      ...
      0 !== $(e).length &&
        ($(e + ' option[value="' + Cookies.get("header-styling") + '"]').prop(
          "selected",
          !0
        ),
        $(e).trigger("change"));
    ...
    if (
      ($(document).on(
        "change",
        ".theme-panel [name=sidebar-styling]",
        function() {
          2 == $(this).val()
      ...
      0 !== $(e).length &&
        ($(e + ' option[value="' + Cookies.get("sidebar-styling") + '"]').prop(
          "selected",
          !0
        ),
        $(e).trigger("change"));
    ...
    if (
      ($(document).on(
        "change",
        ".theme-panel [name=content-gradient]",
        function() {
          2 == $(this).val()
      ...
      0 !== $(e).length &&
        ($(e + ' option[value="' + Cookies.get("content-gradient") + '"]').prop(
          "selected",
          !0
        ),
        $(e).trigger("change"));
    ...
    if (
      ...
      0 !== $(e).length &&
        ($(e + ' option[value="' + Cookies.get("content-styling") + '"]').prop(
          "selected",
          !0
        ),
        $(e).trigger("change"));
    ...
    if (
      ...
      0 !== $(e).length &&
        ($(e + ' option[value="' + Cookies.get("direction") + '"]').prop(
          "selected",
          !0
        ),
        $(e).trigger("change"));
    ...
    function a(e, a) {
      ...
      switch (
        ...
        case "prev":
          var r;
          (r = -o) <= i
            ? ($(t).removeClass("overflow-left"), (l = 0))
            : (l = r - i + 80),
            $("body").hasClass("rtl-mode")
              ? $(t)
                  .find(".nav.nav-tabs")
  ...
  handleToggleNavProfile = function() {
    ...
    $('[data-toggle="nav-profile"]').click(function(e) {
      ...
      var a = $(this).closest("li"),
        ...
        o = "closing";
      $(t).is(":visible")
        ? ($(a).removeClass("active"), $(t).removeClass(o))
        : ($(a).addClass("active"), $(t).addClass(n)),
  ...
  handleSidebarMinifyFloatMenu = function() {
    $(document).on("click", "#float-sub-menu li.has-sub > a", function(e) {
      var a = $(this).next(".sub-menu"),
        ...
        d = !1;
      $(a).is(":visible")
        ? ($(t).addClass("closing"), (r = !0))
        : ($(t).addClass("expanding"), (d = !0)),
        $(a).slideToggle({
          duration: 250,
          progress: function() {
          ...
          complete: function() {
            $(a).is(":visible")
              ? $(t).addClass("expand")
              : $(t).addClass("closed"),
              $(t).removeClass("closing expanding");
          }
        });
    }),
          ...
          if ($("#page-container").hasClass("page-sidebar-minified")) {
            ...
            if (a) {
              var t = $("#sidebar").offset(),
                n = $("#page-container").hasClass("page-with-right-sidebar")
                  ? $(window).width() - t.left
                  : t.left + 60,
                o = $(e).height(),
                i = $(this).offset().top - $(window).scrollTop(),
                s = $("#page-container").hasClass("page-with-right-sidebar")
                  ? "auto"
                  : n,
                l = $("#page-container").hasClass("page-with-right-sidebar")
                  ? n
                  : "auto",
                r = $(window).height();
              if (
                (0 === $("#float-sub-menu").length
                  ...
                  : ($("#float-sub-menu").attr("data-offset-top", i),
                    $("#float-sub-menu").attr("data-menu-offset-top", i),
                    $(".float-sub-menu").html(a)),
                o < r - i)
              )
                $("#float-sub-menu").css({
                  top: i,
  ...
  handleAjaxMode = function(c) {
    ...
    function a(e, a, t) {
      ...
      Pace.restart(),
        ...
        t ||
          ((o = e.replace("#", "")),
          (i = window.navigator.userAgent.indexOf("MSIE ")) && 0 < i && i < 9
      ...
      a &&
        ((d = $(a).attr("data-type") ? $(a).attr("data-type") : d),
        (targetDataDataType = $(a).attr("data-data-type")
          ? $(a).attr("data-data-type")
          : d)),
        $.ajax({
          url: l,
          type: r,
    ...
    "" === (e = window.location.hash ? window.location.hash : e)
      ? $("#content").html(h)
      : a(e, "", !0),
