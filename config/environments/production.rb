Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ 'ws://aws-production.5fsrj3kfbx.us-west-2.elasticbeanstalk' ]
  ...
  # config.active_job.queue_name_prefix = "regency_app_#{Rails.env}"
